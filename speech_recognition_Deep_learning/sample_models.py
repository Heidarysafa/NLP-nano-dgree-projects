...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    for layer in range(recur_layers):
        ...
        return_sequences=True, implementation=2, name='rnn{}'.format(layer))(previous_layer)
        # TODO: Add batch normalization 
        bn_rnn = BatchNormalization()(simp_rnn)
...
def final_model(input_dim, units,filters, kernel_size, conv_stride, conv_border_mode,output_dim=29):
    ...
    simp_rnn = Bidirectional(GRU(units, activation='relu',dropout=0.25,
        return_sequences=True, implementation=2, name='rnn'))(bn_cnn)
        # TODO: Add batch normalization 
    bn_rnn = BatchNormalization()(simp_rnn)
    simp_rnn2 = Bidirectional(GRU(units, activation='relu',dropout=0.25,
